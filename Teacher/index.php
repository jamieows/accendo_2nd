...
/* AUTO-CREATE uploaded_at COLUMN */
...
<style>
    :root {
        ...
        --primary-gradient: linear-gradient(135deg, #7B61FF, #A78BFA);
        --danger: #EF4444;
        --success: #10B981;
        --text: #1e293b;
        --text-light: #64748b;
        ...
        --shadow-hover: 0 20px 50px rgba(123,97,255,0.2);
        --radius: 18px;
    }
    ...
    .dark-mode {
        ...
        --shadow-hover: 0 25px 60px rgba(123,97,255,0.3);
...
<div class="dashboard">
    ...
    <div class="activity-card">
        ...
        <ul class="activity-list">
            ...
            if (empty($activities)) {
                echo '<li class="empty-activity">No recent activity yet. Start uploading!</li>';
            } else {
...
<!-- GLOBAL THEME SYNC - Same as all your other pages -->
<script>

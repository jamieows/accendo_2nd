<aside id="sidebar" class="sidebar">
  <button id="sidebar-toggle" class="sidebar-toggle" aria-label="Toggle sidebar" aria-expanded="true">☰</button>

  <div class="logo">
    <span class="brand">Accendo</span>
    <span class="tagline">when vision meets innovasion</span>
  </div>
...
<style>
  ...
  /* collapsed state: narrow, only icons visible */
  ...
  /* hover / expand interaction: when collapsed and user hovers -> temporarily expand (smooth) */
  ...
  /* make menu items "bigger" on hover with smooth animation */
